...
$required = @(
    ...
    'PASS: exact SSH.NET 2026.0.0 and its twelve-file net48 runtime closure loaded.',
    'PASS: structured SSH options require an explicit valid SHA256 trust fingerprint before authentication.',
