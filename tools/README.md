...
| `Package-VT7KnownHostsManagementInheritedAcl.ps1` | Creates non-overwriting 0.12.3/ABI 11 KH01.4 package 0.8. It changes the inherited-ACL fixture to use the production structural security contract after package 0.7 fails that obsolete exact-SDDL assertion on NESSY. `Verify-VT7KnownHostsManagementInheritedAclPackage.ps1` checks the archive and extracted launcher. Package 0.8 passes the automated and controlled live known-host matrix on NESSY and TURTLE. |
