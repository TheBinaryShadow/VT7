...
Last reconciled: 2026-09-14, after accepting the 0.3.7 Windows 7 result.
...
11. [OpenSSH S00 evaluation](validation/2026-09-14-openssh-s00.md): accepted
    ...
    rejection of redirected interactive PTY geometry; and the approved S01
    SSH.NET candidate.
...
13. [Third-party licensing policy](architecture/2026-09-14-third-party-licensing-policy.md):
...
- [OpenSSH S00 preflight](validation/2026-09-14-openssh-s00.md): the MIT-only
  ...
  rejects it for interactive SSH. SSH.NET 2026.0.0 is approved for S01 testing.
