...
Implementation update, 2026-09-14: P01 completes that comparison on Windows 7
and selects pinned WinPTY 0.4.3 for local legacy-console sessions within explicit
raw-VT, code-page, cursor-width and intermediate-state limits. I01 now defines
the Windows 7 Croatian native-HWND input boundary. Implement its outbound queue
contract, then complete S00 before substantial backend integration.
