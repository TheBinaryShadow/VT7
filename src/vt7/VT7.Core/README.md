...
Engineering version 0.8.2 builds the real Microsoft Terminal core, parser, dispatch,
...
current 0.8.2 source uses ABI 11 and also contains the accepted direct SSH.NET root
