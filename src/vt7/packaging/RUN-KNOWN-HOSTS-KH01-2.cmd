...
set "code=%errorlevel%"
if not "%code%"=="0" echo VT7 KH01.2 read-only known-host validation failed with exit code %code%.
if "%code%"=="0" echo VT7 KH01.2 read-only known-host validation passed.
