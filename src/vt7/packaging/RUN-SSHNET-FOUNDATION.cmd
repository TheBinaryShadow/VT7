...
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -File "%~dp0Test-VT7SshNetFoundation.ps1" -Configuration Release -BinaryDirectory "%~dp0." -OutputDirectory "%VT7_OUTPUT%"
set "code=%errorlevel%"
