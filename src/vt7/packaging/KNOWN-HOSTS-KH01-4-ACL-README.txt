VT7 OpenSSH-compatible known-host management KH01.4 package 0.6
================================================================
...
after replacement. Version 0.12.1/package 0.6 copies the reviewed descriptor
into a fresh FileSecurity object and verifies the temporary file's owner,
group and DACL before replacing anything. The disposable test now gives the
primary file a protected ACL distinct from the temporary file's inherited ACL.
