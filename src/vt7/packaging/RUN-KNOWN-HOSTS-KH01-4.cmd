...
set "code=%errorlevel%"
if not "%code%"=="0" echo VT7 KH01.4 management known-host validation failed with exit code %code%.
if "%code%"=="0" echo VT7 KH01.4 management known-host validation passed.
if not defined VT7_TEST_NO_PAUSE pause
exit /b %code%

:unsupported_ps
echo VT7 KH01.4 test requires Windows PowerShell 5.1 or newer.
