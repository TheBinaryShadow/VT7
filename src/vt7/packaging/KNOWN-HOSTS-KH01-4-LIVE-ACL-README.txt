VT7 OpenSSH-compatible known-host management KH01.4 package 0.7
================================================================
...
descriptor, whose auto-inheritance control bits can differ. A mismatch still
stops before mutation and reports the mismatched security component. The
disposable corpus covers both protected and inherited file ACLs. The changed
key-row text also has an explicit dark foreground on the white dialog.
